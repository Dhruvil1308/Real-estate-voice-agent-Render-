...
x-terminal-emulator -T "Real Estate Voice Agent Backend" -e bash -c "echo 'Starting Backend...'; source .venv/bin/activate && uvicorn server:app --host 0.0.0.0 --port 8000 --reload; echo -e '\nProcess stopped.'; exec bash" &
